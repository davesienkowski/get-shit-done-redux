...
| `probe-registry.cjs` | Static probe self-description registry (compiled from `src/probe-registry.cts`, gitignored; ADR-20) — a hand-maintained list of the three adapter `ProbeDescriptor`s (edge/prohibition/ui), the code form of the `CONTEXT.md:416` family predicate; NOT a plugin loader (Gall); consumed by the generated probe manifest and the `probe list`/`describe` command; exports `PROBE_REGISTRY`, `getProbeDescriptor` (#20) |
